...
export default async function LoginPage({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center bg-background overflow-hidden p-6">
      ...
      <div className="absolute top-[10%] right-[10%] w-[30%] h-[30%] rounded-full bg-primary/15 blur-[100px] pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        {/* Card */}
        <div className="backdrop-blur-xl bg-surface/90 border border-border rounded-2xl p-8 shadow-2xl">
          <div className="mb-8 text-center">
            <h1 className="text-2xl font-bold tracking-tight text-foreground">Welcome Back</h1>
            <p className="mt-2 text-sm text-foreground/50">Sign in to manage your SlashBot.</p>
          </div>
          ...
          <form action={authenticate} className="space-y-5">
            <div>
              ...
              <input
                ...
                type="email"
                required
                className="block w-full rounded-xl bg-background border border-border py-2.5 px-4 text-foreground shadow-sm placeholder:text-foreground/30 focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all text-sm"
